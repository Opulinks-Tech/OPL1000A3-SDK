...
int wifi_event_sta_connect_failed_handler(wifi_event_t event, uint8_t *data, uint32_t length);
...
typedef int (*wifi_event_sta_connect_failed_handler_fp_t)(wifi_event_t event, uint8_t *data, uint32_t length);
...
extern wifi_event_sta_connect_failed_handler_fp_t wifi_event_sta_connect_failed_api;
