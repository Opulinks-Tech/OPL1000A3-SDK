...
typedef int (*wifi_reset_fp_t)(void);
...
typedef int (*wifi_config_get_bcn_track_boost_fp_t)(uint16_t *value);
typedef int (*wifi_config_set_bcn_track_boost_fp_t)(uint16_t value);
typedef int (*wifi_config_get_bcn_track_plus_fp_t)(wifi_sta_bcn_btp_t *btp);
typedef int (*wifi_config_set_bcn_track_plus_fp_t)(wifi_sta_bcn_btp_t btp);
...
extern wifi_reset_fp_t                                     wifi_reset_api;
...
extern wifi_config_get_bcn_track_boost_fp_t                wifi_config_get_bcn_track_boost_api;
extern wifi_config_set_bcn_track_boost_fp_t                wifi_config_set_bcn_track_boost_api;
extern wifi_config_get_bcn_track_plus_fp_t                 wifi_config_get_bcn_track_plus_api;
extern wifi_config_set_bcn_track_plus_fp_t                 wifi_config_set_bcn_track_plus_api;
