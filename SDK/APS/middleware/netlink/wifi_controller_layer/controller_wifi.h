...
int controller_wifi_ipc_cmd_send_impl(wifi_cmd_t * pWifiCmd);
...
typedef int (*controller_wifi_cmd_handler_fp_t)(wifi_cmd_t * pWifiCmd);
typedef int (*controller_wifi_ipc_cmd_send_fp_t)(wifi_cmd_t * pWifiCmd);
...
extern controller_wifi_cmd_handler_fp_t controller_wifi_cmd_handler;
extern controller_wifi_ipc_cmd_send_fp_t controller_wifi_ipc_cmd_send;
