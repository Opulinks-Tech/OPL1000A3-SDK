...
/**
  ...
  *
  * @return    0  : WIFI_SUCCESS
  *            -1 : WIFI_COMMON_ERROR
  *            -2 : WIFI_INVALID_PARAM
  *            -3 : WIFI_AP_NOT_EXISTS
  *            -10 : WIFI_IN_SCANNING
  *            -11 : WIFI_IN_CONNECTING
  *            -12 : WIFI_IN_CONNECTED
  * @return    other : failed
  */
...
/**
  * @brief     Get the Beacon Tracking of Boost
  *
  * @param[in]  value: the Beacon tracking boost interval
  *
  * @return    0  : success
  * @return    other : failed
  *
 */
int wifi_config_get_bcn_track_boost(uint16_t *value);

/**
  * @brief     Set the Beacon Tracking of Boost
  *
  * @attention 1 Set BTB interval if skip DTIM has been set with non-zero value:
  *            When the interval is larger than 0, the function of skip DTIM will be stopped
  *            When the interval is 0, the function of skip DTIM will be resumed
  *
  * @attention 2. unit: ms
  *
  * @param[in]  value: the Beacon tracking boost interval, range in 0 - 65535
  *
  * @return    0  : success
  * @return    other : failed
  *
 */
int wifi_config_set_bcn_track_boost(uint16_t value);

/**
  * @brief     Get the configuration of Beacon Tracking Plus
  *
  * @param[in]  u8InvlDiv: SDTIM interval divisor. Default: 2
  *             u8GaTtlTime: BC/MC listening window limit, unit: ms. Default: 20
  *             u16SkipBMcastInvl: Skip BC/MC indication interval, unit: TIME UNIT. Default: 6500
  *
  * @return    0  : success
  * @return    other : failed
  *
 */
int wifi_config_get_bcn_track_plus(wifi_sta_bcn_btp_t *btp);

/**
  * @brief     Set the configuration of Beacon Tracking Plus
  *
  * @param[in]  u8InvlDiv: SDTIM interval divisor. Default: 2
  *             u8GaTtlTime: BC/MC listening window limit, unit: ms. Default: 20
  *             u16SkipBMcastInvl: Skip BC/MC indication interval, unit: TIME UNIT. Default: 6500
  ...
  *
 */
int wifi_config_set_bcn_track_plus(wifi_sta_bcn_btp_t btp);
