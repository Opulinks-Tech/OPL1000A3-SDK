...
typedef void (*t_le_ctrl_util_encrypt_fp)(uint8_t *key, uint8_t *pData, uint8_t *eData);
typedef uint8_t (*t_le_ctrl_util_gen_key_pair_fp)(uint8_t *pubKey, uint8_t *privKey);
typedef uint8_t (*t_le_ctrl_util_gen_dhkey_fp)(uint8_t *pub_key_x, uint8_t *pub_key_y, uint8_t *priv_key, uint8_t *dhkey);
...
typedef void (*t_vendor_specific_get_packet_info_statistics_event_handler_fp)(hci_event_packet_04 *event_packet);
...
typedef void (*t_le_ctrl_pkt_info_display_timer_fp)(const void *argument);
typedef int (*t_le_ctrl_packet_info_display_fp)(uint8_t enable, int interval);
typedef int (*t_le_ctrl_set_agc_gain_level_fp)(uint8_t rf_gain_level, uint8_t digital_gain_level);
...
extern t_le_ctrl_util_encrypt_fp le_ctrl_util_encrypt;
extern t_le_ctrl_util_gen_key_pair_fp le_ctrl_util_gen_key_pair;
extern t_le_ctrl_util_gen_dhkey_fp le_ctrl_util_gen_dhkey;
...
extern t_vendor_specific_get_packet_info_statistics_event_handler_fp vendor_specific_get_packet_info_statistics_event_handler;
...
extern t_le_ctrl_pkt_info_display_timer_fp le_ctrl_pkt_info_display_timer;
extern t_le_ctrl_packet_info_display_fp le_ctrl_packet_info_display;
extern t_le_ctrl_set_agc_gain_level_fp le_ctrl_set_agc_gain_level;
...
void le_ctrl_util_encrypt_impl(uint8_t *key, uint8_t *pData, uint8_t *eData);
uint8_t le_ctrl_util_gen_key_pair_impl(uint8_t *pubKey, uint8_t *privKey);
uint8_t le_ctrl_util_gen_dhkey_impl(uint8_t *pub_key_x, uint8_t *pub_key_y, uint8_t *priv_key, uint8_t *dhkey);
...
void vendor_specific_get_packet_info_statistics_event_handler_impl(hci_event_packet_04 *event_packet);
...
void le_ctrl_pkt_info_display_timer_impl(const void *argument);
int le_ctrl_packet_info_display_impl(uint8_t enable, int interval);
int le_ctrl_set_agc_gain_level_impl(uint8_t rf_gain_level, uint8_t digital_gain_level);
