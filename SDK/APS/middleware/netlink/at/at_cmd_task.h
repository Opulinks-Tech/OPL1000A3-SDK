...
/**
 * @brief Function Pointer Type for API at_cmd_crlf_term_set
 *
 */
typedef void (*at_cmd_crlf_term_set_fp_t)(uint8_t u8Enable);

/**
 * @brief Function Pointer Type for API at_cmd_crlf_term_get
 *
 */
typedef uint8_t (*at_cmd_crlf_term_get_fp_t)(void);

/**
 * @brief Function Pointer Type for API at_term_char_remove
 *
 */
...
/**
 * @brief Extern Function at_cmd_crlf_term_set
 *
 */
extern at_cmd_crlf_term_set_fp_t at_cmd_crlf_term_set;

/**
 * @brief Extern Function at_cmd_crlf_term_get
 *
 */
extern at_cmd_crlf_term_get_fp_t at_cmd_crlf_term_get;

/**
 * @brief Extern Function at_term_char_remove
 *
 */
