...
uint32_t wifi_mac_xmit_fragment_impl(uint8_t *pu8Payload, uint32_t u32PayloadLen,
...
typedef uint32_t (*wifi_mac_xmit_fragment_fp_t)(uint8_t *pu8Payload, uint32_t u32PayloadLen,
                                const uint8_t *pu8DestAddr, uint16_t u16ProtocalType, int32_t s32Encrypt);
