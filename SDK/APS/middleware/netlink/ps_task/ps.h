...
typedef void (*t_ps_update_io_time_fp)(void);
typedef void (*t_ps_lock_gpio_apply_fp)(void);
...
typedef double (*t_ps_32k_xtal_measure_fp)(uint32_t duration_ms);
...
extern t_ps_update_io_time_fp              ps_update_io_time;
extern t_ps_lock_gpio_apply_fp             ps_lock_gpio_apply;
...
extern t_ps_32k_xtal_measure_fp            ps_32k_xtal_measure;
...
void ps_update_io_time_impl(void);
void ps_lock_gpio_apply_impl(void);
...
double ps_32k_xtal_measure_impl(uint32_t duration_ms);
