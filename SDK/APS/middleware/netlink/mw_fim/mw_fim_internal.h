...
typedef uint8_t (*T_MwFim_GroupSwap_Fp)(uint32_t ulZoneIdx, uint32_t ulGroupIdx, T_MwFimFileData *ptReplaceData);
typedef uint8_t (*T_MwFim_GroupBlockErase_Fp)(uint32_t ulStartAddr, uint32_t ulGroupSize);
...
extern T_MwFim_GroupBlockErase_Fp MwFim_GroupBlockErase;
