...
#define MBEDTLS_PLATFORM_STD_CALLOC   opl_mbedtls_mem_calloc
#define MBEDTLS_PLATFORM_STD_FREE	  opl_mbedtls_mem_free
 ...
 *
 */
#define MBEDTLS_SSL_IN_CONTENT_LEN             mbedtls_ssl_in_content_len
 ...
 */
#define MBEDTLS_SSL_OUT_CONTENT_LEN            mbedtls_ssl_out_content_len
