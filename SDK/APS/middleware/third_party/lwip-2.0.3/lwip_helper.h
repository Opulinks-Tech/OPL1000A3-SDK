...
typedef int32_t (*wifi_station_connect_failed_event_handler_fp_t)(void *arg);
...
extern wifi_station_connect_failed_event_handler_fp_t wifi_station_connect_failed_event_handler;
