...
//driver netlink error code
#define WPA_DRIVER_OK               0
#define WPA_DRIVER_COMMON_ERROR     -1
#define WPA_DRIVER_INVALID_PARAM    -2
#define WPA_DRIVER_AP_NOT_EXISTS    -3
#define WPA_DRIVER_IN_SCANNING      -10
#define WPA_DRIVER_IN_CONNECTING    -11
#define WPA_DRIVER_IN_CONNECTED     -12
...
typedef int (*wpa_driver_netlink_reset_fp_t)(void);
typedef int (*wpa_driver_netlink_scan_fp_t)(int mode);
...
typedef int (*wpa_driver_netlink_connect_fp_t)(struct wpa_config * wconf);
typedef int (*wpa_driver_netlink_connect_from_ac_fp_t)(u8 index);
typedef int (*wpa_driver_netlink_reconnect_fp_t)(struct wpa_config * conf);
typedef Boolean (*wpa_driver_netlink_associate_fp_t)(void *priv, struct wpa_driver_associate_params *params);
typedef int (*wpa_driver_netlink_disconnect_fp_t)(const u8 *bssid, u16 reason_code);
...
typedef int (*wpa_driver_netlink_connect_by_bssid_fp_t)(u8 *bssid);
...
typedef int (*wpa_driver_netlink_fast_connect_set_fp_t)(u8 mode, u8 index);
typedef int (*wpa_driver_netlink_sta_cfg_fp_t)(u8 mode, u8 cmd_idx, void *value);
typedef int (*wpa_driver_netlink_get_state_fp_t)(void);
typedef int (*wpa_driver_netlink_scan_by_cfg_fp_t) (void *cfg);
...
typedef int (*wpa_driver_cal_psk_fp_t)(char *pssid, uint16_t ssid_len, char *ppassphrase, uint16_t pass_len);
typedef char * (*get_ssid_by_bsssid_fp_t)(char *pbssid);
...
extern wpa_driver_netlink_reset_fp_t wpa_driver_netlink_reset;
...
extern wpa_driver_netlink_fast_connect_set_fp_t wpa_driver_netlink_fast_connect_set;
...
extern wpa_driver_cal_psk_fp_t wpa_driver_cal_psk;
extern get_ssid_by_bsssid_fp_t get_ssid_by_bsssid;
