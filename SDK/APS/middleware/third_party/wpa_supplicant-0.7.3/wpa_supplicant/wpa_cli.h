...
#define WPA_CLI_CMD_FAST_CONNECT    "wpa_fast_connect_set"
...
typedef int (*wpa_cli_clean_ac_list_fp_t) (void);
typedef int (*wpa_cli_fast_connect_set_fp_t) (int argc, char *argv[]);
typedef int (*wpa_cli_dbg_fp_t) (int argc, char *argv[]);
typedef int (*wpa_cli_cmd_reset_fp_t) (int argc, char *argv[]);
...
extern wpa_cli_clean_ac_list_fp_t wpa_cli_clean_ac_list;
extern wpa_cli_fast_connect_set_fp_t wpa_cli_fast_connect_set;
extern wpa_cli_dbg_fp_t wpa_cli_dbg;
extern wpa_cli_cmd_reset_fp_t wpa_cli_cmd_reset;
