...
#define tuya_hal_ota_start_inform tuya_os_adapt_ota_start_inform
...
#define tuya_hal_ota_data_process tuya_os_adapt_ota_data_process
...
#define tuya_hal_ota_end_inform tuya_os_adapt_ota_end_inform
