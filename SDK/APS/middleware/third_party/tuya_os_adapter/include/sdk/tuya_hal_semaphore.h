...
#if !defined(UN_USE_HAL_REGISTERED)
 ...
 * @return int 0=成功，非0=失败
 */
#define tuya_hal_semaphore_create_init tuya_os_adapt_semaphore_create_init
 ...
 * @return int 0=成功，非0=失败
 */
#define tuya_hal_semaphore_wait tuya_os_adapt_semaphore_wait
 ...
 * @return int 0=成功，非0=失败
 */
#define tuya_hal_semaphore_waittimeout tuya_os_adapt_semaphore_waittimeout
 ...
 * @return int 0=成功，非0=失败
 */
#define tuya_hal_semaphore_post tuya_os_adapt_semaphore_post
 ...
 * @return int 0=成功，非0=失败
 */
#define tuya_hal_semaphore_release tuya_os_adapt_semaphore_release
