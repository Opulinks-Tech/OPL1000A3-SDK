 ...
 * @return int 0=成功，非0=失败
 */
#define tuya_hal_mutex_create_init  tuya_os_adapt_mutex_create_init
 ...
 * @return int 0=成功，非0=失败
 */
#define tuya_hal_mutex_lock tuya_os_adapt_mutex_lock
 ...
 * @return int 0=成功，非0=失败
 */
#define tuya_hal_mutex_unlock tuya_os_adapt_mutex_unlock
 ...
 * @return int 0=成功，非0=失败
 */
#define tuya_hal_mutex_release tuya_os_adapt_mutex_release
