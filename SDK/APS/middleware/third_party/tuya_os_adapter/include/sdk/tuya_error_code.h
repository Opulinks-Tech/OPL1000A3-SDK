...
#define OPRT_LINK_CORE_HTTP_CLIENT_HEADER_ERROR            (-0x1e08)  //HTTP头初始化失败
#define OPRT_LINK_CORE_HTTP_CLIENT_SEND_ERROR              (-0x1e09)  //HTTP请求发送失败
#define OPRT_LINK_CORE_HTTP_RESPONSE_BUFFER_EMPTY          (-0x1e0a)  //HTTPb buffer为空
#define OPRT_LINK_CORE_HTTP_GW_NOT_EXIST                   (-0x1e0b)  //网关不存在，可能设备已被删除
