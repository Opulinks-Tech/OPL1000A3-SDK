...
#define configTIMER_TASK_PRIORITY               6                               // (OS_TASK_PRIORITY_TIMER - OS_TASK_PRIORITY_IDLE)
#define configTIMER_QUEUE_LENGTH                10
#define configTIMER_TASK_STACK_DEPTH            128                             // OS_TASK_STACK_SIZE_TIMER

/* Interrupt nesting behaviour configuration. */
/* This is the raw value as per the Cortex-M3 NVIC.  Values can be 255
(lowest) to 0 (1?) (highest). */
#define configKERNEL_INTERRUPT_PRIORITY         IRQ_PRIORITY_TICK   //255
/* !!!! configMAX_SYSCALL_INTERRUPT_PRIORITY must not be set to zero !!!!
See http://www.FreeRTOS.org/RTOS-Cortex-M3-M4.html. */
#define configMAX_SYSCALL_INTERRUPT_PRIORITY    IRQ_PRIORITY_SYS    //191 /* equivalent to 0xb0, or priority 11. */
