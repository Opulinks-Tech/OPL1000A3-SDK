...
// External
T_Hal_Pin_ConfigSet_Fp Hal_Pin_ConfigSet;
T_Hal_Pin_SetAutoControl Hal_Pin_SetAutoControl;
T_Hal_Pin_IoConfigSet_Fp g_taHal_Pin_IoConfigTbl[HAL_PIN_IO_COUNT];
 ...
 */
void Hal_Pin_SetAutoControl_impl(uint8_t ubIoIdx, uint16_t uwConfig)
{
    switch (uwConfig)
    {
        /* Auto pull high */
...
void Hal_Pin_PreInitCold(void)
{
    ...
    Hal_Pin_SetAutoControl = Hal_Pin_SetAutoControl_impl;
