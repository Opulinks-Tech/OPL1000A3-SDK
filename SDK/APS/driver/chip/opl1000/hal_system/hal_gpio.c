...
T_Hal_Gpio_SleepIoUsrCtrlSet    Hal_Gpio_SleepIoUsrCtrlSet;
T_Hal_Gpio_SleepIoUsrCtrlGet    Hal_Gpio_SleepIoUsrCtrlGet;
T_Hal_Gpio_SleepIoAutoCtrlSet   Hal_Gpio_SleepIoAutoCtrlSet;
T_Hal_Gpio_SleepIoAutoCtrlGet   Hal_Gpio_SleepIoAutoCtrlGet;
T_Hal_Gpio_Init                 Hal_Gpio_Init;
...
void Hal_Gpio_PreInit(void)
{
    Hal_Gpio_SleepIoUsrCtrlSet       = Hal_Gpio_SleepIoUsrCtrlSet_impl;
    Hal_Gpio_SleepIoUsrCtrlGet       = Hal_Gpio_SleepIoUsrCtrlGet_impl;
    Hal_Gpio_SleepIoAutoCtrlSet      = Hal_Gpio_SleepIoAutoCtrlSet_impl;
    Hal_Gpio_SleepIoAutoCtrlGet      = Hal_Gpio_SleepIoAutoCtrlGet_impl;
    Hal_Gpio_Init                    = Hal_Gpio_Init_impl;
...
/**
 * @brief Initial sleep IO configuration
 */
void Hal_Gpio_Init_impl(void)
{
    g_psHal_Gpio_SleepIoCfg = (S_SLEEP_IO_CFG *)IPC_SLEEP_IO_START;
