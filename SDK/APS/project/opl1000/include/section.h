...
#elif defined(GROUP_TUYA_OS_ADAPTER)
    #pragma arm section rwdata="group_tuya_os_adapter", zidata="group_tuya_os_adapter"
#elif defined(GROUP_HTTPCLIENT)    
    #pragma arm section rwdata="group_httpclient", zidata="group_httpclient"
#else
